...
require_once('admin/class/aboutUs.class.php');
...
$aboutObject = new AboutUs();
$aboutMe = $aboutObject->getAboutUs();
$categoryObject = new Category();
$categoryNepal = $categoryObject->getCategoryNepal();
                ...
                <div class="nav-wrapper">
                  <ul class="nav-list mega-menu">
                    ...
                    <li class="menu-item drop-mega dropdown">
                      ...
                      <ul class="dropdown-menu" id="parent_drop">


                        <?php foreach ($categoryNepal as $category) { ?>
                          <li class="menu-item dropdown">
